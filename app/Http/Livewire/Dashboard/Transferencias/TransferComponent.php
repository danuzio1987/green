...
namespace App\Http\Livewire\Dashboard\Transferencias;
...
class TransferComponent extends Component
{
    ...
    public function mount()
    {
        ...
        if ($this->verifica == true) {
            $this->start();
            $this->updateDashboardTransferencia();
        }
     ...
     public function start()
     {
        ...
        $this->transferencias = Transferencia::with("details")->get();
        $this->detalhes = Detalhamento::get();
     
         $this->report_date = date("Y-m-d", strtotime(now()));
         $this->data_inferior = date("Y-m-d", strtotime("2005-01-01"));
     }
 
     public function updateDashboardTransferencia()
     {
    ...
    {
        return view('livewire.dashboard.transferencias.transfer-component');
    }
}
