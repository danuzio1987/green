...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <title>@yield('title') - Green Distribuidora</title>
    <link rel="apple-touch-icon" href="{{asset('images/logo/icone_green.png')}}">
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('images/logo/icone_green.png')}}">
