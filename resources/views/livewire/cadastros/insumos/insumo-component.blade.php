<div class="row">
              ...
              <div class="card {{$form_mode === "edit" ? "bg-rgba-warning" : ""}}">
                <div class="card-header">
                  <h4 class="text-bold-600">
                      {{$form_mode === "edit" ? "Editar Insumo" : "Cadastrar Insumo"}}
                  </h4>
                </div>
                <div class="card-body">
                  <div class="row">
                      <div class="col-12">
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="name" name="name" wire:model.defer='name' wire:keydown.enter="{{ $form_mode === "create" ? 'createInsumo' : 'editInsumo'}}" placeholder="Identifique o novo insumo" autocomplete="off">
                              @error('name')
                      ...
                      <div class="col-12 ">
                        ...
                        <div class="d-flex justify-content-end">
                          @if ($form_mode === "edit")
                            <a href="" wire:click.prevent='editInsumo' class="btn btn-warning mr-1">
                              <i class="bx bx-save mr-1"></i>
                              Atualizar
                            </a>
                          @else
                            <a href="" wire:click.prevent='createInsumo' class="btn btn-light-success mr-1">
                              <i class="bx bx-save mr-1"></i>
                              Criar
                            </a>
                          @endif
            ...
            <div class="col-12">
              <div class="card">
                @if ($insumos->count() > 0)
                  ...
                  <div class="card-body">
                      <p>
                        Abaixo estão listados todos os insumos cadastrados na plataforma.
                      </p>
    ...
    <script>
      window.addEventListener("sucesso-salva-insumo", function(){
    ...
    <script>
      window.addEventListener("sucesso-edita-insumo", function(){
