...
<div class="row" id="table-inverse">
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        <p class="mb-0">You can also invert the colors—with light text on dark backgrounds—with <code class="highlighter-rouge">.table-dark</code>.</p>
      </div>
      <!-- table with dark -->
      <div class="table-responsive">
        <table class="table table-dark mb-0">
          ...
          <tbody>
            <tr>
              ...
              <td>Remote</td>
              <td>Austin,Taxes</td>
              <td><a href="javascript:void(0);"><i class="badge-circle bx bx-envelope font-medium-1"></i></a></td>
            </tr>
            <tr>
              <td class="text-bold-500">Morgan Vanblum</td>
              <td>$13/hr</td>
      ...
      <div class="card-body">
        <p class="mb-0">You can also invert the colors—with dark text on light backgrounds—with <code class="highlighter-rouge">.table-light</code>.</p>
      </div>
      <!-- table with light -->
      <div class="table-responsive">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="alert bg-rgba-primary mt-1 p-1">
          ...
          <p class="m-0">Responsive tables make use of <code class="highlighter-rouge">overflow-y: hidden</code>,
            which clips off
